...
public class DateUtils {
	 ...
	 *
	 * @param day
	 *            Can be: <li>QuickUtils.date.YESTERDAY</li><li>QuickUtils.date.TODAY</li><li>QuickUtils.date.TOMORROW</li>
	 * @param format
	 ...
	 *
	 * @param day
	 *            Can be: <li>QU.date.YESTERDAY</li><li>QU.date.TODAY</li><li>QU.date.TOMORROW</li>
	 ...
	 * @param useShort
	 *            boolean that gives "Jun" instead of "June" if true
