...
public class AnimationUtils {
	 ...
	 * @param duration
	 *            for how long in ms will it blink
	 * @param offset
	 *            start offset of the animation
	 ...
	 */
	@SuppressLint("NewApi") public class Fade {
		 ...
		 *
		 * @param duration
		 *            The length of time, in milliseconds, that fade animations will
		 ...
		 *
		 * @param view
		 *            The view that will be faded and removed.
		 */
		 ...
		 *            The parent to which the view is added
		 * @param index
		 *            The index at which the view is added in the parent's child list
		 */
		 ...
		 *
		 * @param view
		 *            The view to be hidden
		 * @param visibility
		 *            The value to which the view's visibility will be set after it fades out.
