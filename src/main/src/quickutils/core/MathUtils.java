...
public class MathUtils {
	...
	public static double round(double toBeRounded, int digits) {
		if (digits < 0) {
			QUFactory.QLog.error("must be greater than 0");
			return 0;
		}
		String formater = "";
	 ...
	 * Special cases: <li>log(+0.0) = -infinity</li> <li>log(-0.0) = -infinity</li><li>log((anything < 0) = NaN</li> <li>
	 * log(+infinity) = +infinity</li><li>log(-infinity) = NaN</li><li>log(NaN) = NaN</li>
	 * 
	 * @param number
